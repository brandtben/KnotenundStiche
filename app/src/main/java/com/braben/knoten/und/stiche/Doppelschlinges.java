 ...
 *
 */
public class Doppelschlinges extends Fragment implements Button.OnClickListener {
    ...
    public static Doppelschlinges newInstance(int section_number) {
        Doppelschlinges fragment = new Doppelschlinges();
        Bundle args = new Bundle();
        args.putInt(ARG_SECTION_NUMBER, section_number);
        fragment.setArguments(args);
        return fragment;
    }
    public Doppelschlinges() {
