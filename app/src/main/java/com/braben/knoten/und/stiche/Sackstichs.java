 ...
 *
 */
public class Sackstichs extends Fragment implements Button.OnClickListener {
    ...
    public static Sackstichs newInstance(int section_number) {
        Sackstichs fragment = new Sackstichs();
